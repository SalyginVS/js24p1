...
function t05 () {
    ...
    // console.log(document.querySelector('.out-5').classList)
}
...
function t09 () {
    const ch91 = document.querySelector('input.ch-91');
    const ch92 = document.querySelector('input.ch-92');
    const out9 = document.querySelector('.out-9');

    if (ch91.checked) out9.classList.add('bold');
    else if (!ch91.checked) out9.classList.remove('bold');

    if (ch92.checked) out9.classList.add('uppercase');
    else if (!ch92.checked) out9.classList.remove('uppercase');
}
