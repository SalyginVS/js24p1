...
function t01() {
    document.querySelector('.out-1').textContent = document.querySelector('html').lang;
}
...
function t04() {
    document.querySelector('#d-3').id = 'd-4';
...
function t05() {
    document.querySelector('input.i-5').type = 'password';
}
...
function t06() {
    document.querySelector('input.i-6').setAttribute('placeholder', 'Arch Druidess');
}
...
function t07() {
    document.querySelector('.out-7').textContent = document.querySelector('.img-7').getAttribute('alt');
}
...
function t08() {
    document.querySelector('.img-8').src = './images/witch.png';
}
...
function t09() {
    document.querySelector('input.ch-9').setAttribute('checked', 'true');
}
...
function t11() {
    document.querySelector('input.i-11').setAttribute('disabled', 'true');
}
...
function t15() {
    if (!document.querySelector('div.out-15').hasAttribute('hidden')) document.querySelector('div.out-15').setAttribute('hidden', 'true');
    else if (document.querySelector('div.out-15').hasAttribute('hidden')) document.querySelector('div.out-15').removeAttribute('hidden');
}
