...
function t05() {
    ...
    input.oninput = t06;
    document.querySelector('.out-5').append(input);
}
...
function t07() {
    ...
    option1.value = '22';
    option1.text = 'Лето II Атрейдес';
    option2.value = '33';
    option2.text = 'Дункан Айдахо';

    select.append(option1);
    select.append(option2);

    document.querySelector('.out-7').append(select);
}
...
function t08() {
    let text = document.querySelector('input.i-8').value;
