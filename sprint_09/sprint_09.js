...
function t02() {
    let out = '';
    let inputVal = +document.querySelector('.i-2').value;
    let i = 0;
    while (i < inputVal) {
        out += '_*';
        i++;
...
function t03() {
    let out = '';
    let inputVal = +document.querySelector('.i-3').value;
    let i = 0;
    while (i <= inputVal) {
        out += `${i}_`;
        i++;
...
function t07() {
    ...
    let i = 10;
    while (i <= 99) {
        if (Math.trunc(i / 10) + (i % 10) === 8) out += `${i}_`;
        i++;
    }
...
function t09() {
    let out = '';
    let inputVal = +document.querySelector('.i-9').value;
    let i = 0;
    while (i < inputVal) {
        out += '******<br>';
        i++;
