...
let html110 = document.querySelector('.out-110').innerHTML;
let out111 = document.querySelector('.out-111');
out111.innerHTML = html110;
...
let html120 = document.querySelector('.out-120').innerHTML;
document.querySelector('.out-121').innerHTML = html120;
