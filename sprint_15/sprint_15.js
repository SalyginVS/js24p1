...
const t07 = () => {
    document.querySelector('.block-7').addEventListener("contextmenu", (e) => {
        e.preventDefault();
    });
};
...
const t09 = () => {
    engle += 15;
    document.querySelector('.block-9').style.transform += `rotate(${engle}deg)`;
}
...
const t12 = () => {
    document.querySelector('.out-12').textContent = document.querySelector('input.i-12').value;
}

// тут напишите событие
document.querySelector('input.i-12').addEventListener('input', t12);
...
// тут напишите событие
document.querySelector('input.i-13').addEventListener('copy', t13);
...
const t14 = () => {
    document.querySelector('.out-14').textContent = document.querySelector('input.i-14').value;
}

// тут напишите событие
document.querySelector('input.i-14').addEventListener('paste', t14);
...
const t15 = () => {
    document.querySelector('.i-15').setAttribute('placeholder', 'cut');
}

// тут напишите событие
document.querySelector('input.i-15').addEventListener('cut', t15);
...
// тут напишите событие
document.querySelector('input.i-16').addEventListener('focus', t16);
...
// тут напишите событие
document.querySelector('input.i-16').addEventListener('blur', t17);
...
///////////////// Постановка не полная или не точная 
...
// тут напишите событие
//document.querySelector('input.i-19').addEventListener('canсel', useFunction);
//document.querySelector('input.i-19').addEventListener('click', t19);
